...
def write_with_outline(
    draw, xy, text, font, fill_text=(255, 255, 255, 255), fill_outline=(0, 0, 0, 255)
):
...
def write_with_shadow(
    img, xy, text, font, fill=(255, 255, 255, 255), halo_fill=(0, 0, 0, 255)
):
    x, y = xy
